...
const SkillCard = ({skill,percentage,color,move}) => {
  return <div className={`border border-[rgba(255,255,255,0.3)] rounded-md px-8 py-3 cursor-pointer group w-full flex items-center justify-between relative gap-2`}
  style={{
